...
public class FP_Player_Inspector : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (fP_Controller.canRun)
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("runKey"), GUIContent.none);
        }
        ...
        if (fP_Controller.canJump)
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("jumpKey"), GUIContent.none);
        }
        ...
        if (fP_Controller.canCrouch)
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("crouchKey"), GUIContent.none);
        }
